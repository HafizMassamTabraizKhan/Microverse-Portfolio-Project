  ...
  let modalContent = `
      <div class= "project-overlay project-card">
          ...
          <ul class="work-cat role">`;
              ...
              {
                  if(i === 0)
                  modalContent += `<li class="cat-title"><a href="#">${workCardInf.cat[i]}</a></li>`;
                  else if(i === 1 || i === 3)
                  modalContent += `<li class="cat-title"><img src="${workCardInf.cat[i]}" /></li>`;
                  else
...
function renderworks() {
    ...
    for(let i = 0; i < works2.length; i += 1) {
        ...
        if(i === 0)
        projectOverlay.classList.add('project-card', `card${i+1}`);
        else
        projectOverlay.classList.add('project-card', 'card-margin', `card${i+1}`);
        ...
        cardContent += `
            ...
            <div class="project-detail">
                ...
                <ul class="role">`;
                    ...
                    {
                        if(i === 0)
                        cardContent += `<li><a href="#">${workCardInf.cat[i]}</a></li>`;
                        else if(i === 1 || i === 3)
                        cardContent += `<li><img src="${workCardInf.cat[i]}" /></li>`;
                        else
                        cardContent += `<li>${workCardInf.cat[i]}</li>`;
                ...
                <ul class="skills">`;
                    workCardInf.tags.forEach((tag) => {
                        cardContent += `<li class="work-lang">${tag}</li>`;
                    });
